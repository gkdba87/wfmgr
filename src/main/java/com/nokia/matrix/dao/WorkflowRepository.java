...
public interface WorkflowRepository extends CrudRepository<Workflow, Long>{
	...
	@Query("select w.id, w.name from Workflow w where w.userName=:userName and w.projectId=:projectId and w.jiraTaskId=:jiraTaskId")
	public List<Object[]> findUserWorkflowsByJiraId(@Param("userName") String userName, @Param("projectId") Integer projectId, @Param("jiraTaskId") String jiraTaskId);
