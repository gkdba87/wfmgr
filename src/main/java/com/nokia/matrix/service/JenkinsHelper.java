...
public class JenkinsHelper {
	...
	public BuildInfo triggerBuild(String taskName, Long workflowId) {
		...
		try {
			...
			BuildResponse buildResp  = getBuildStatus(queueData.getBuildURL());
	...
	private BuildResponse getBuildStatus(String buildUrl) throws Exception {
